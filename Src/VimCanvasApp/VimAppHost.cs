...
namespace VimCanvasApp
{
    ...
    internal sealed class VimAppHost : Vim.UI.Wpf.VimHost
    {
                ...
                editorOperationsFactoryService)
        {
            ...
            _idleFactory = protectedOperations.JoinableTaskFactory; //  protectedOperations.JoinableTaskFactory.WithPriority(Dispatcher.CurrentDispatcher, DispatcherPriority.ApplicationIdle);
        }
